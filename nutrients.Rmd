...
source("functies.R")
# hieronder eerste versies van functies. nog nakijken
...
trendstations <- c("Schaar van Ouden Doel", "Hansweert geul", "Terneuzen boei",
"Vlissingen boei SSVH", "Wielingen", "Walcheren 2 km uit de kust",
...
df$stationname <- factor(df$stationname, levels = trendstations)
```
...
knitr::kable(dt, 
             align = 'c',
             caption = "Gemiddelde, 10 percentiel en 90 percentiel waardes en de trend en p waarde van de trend van het opgelost stikstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```


```{r fysischStikstofFil, fig.cap="Jaarlijks gemiddelde, 10 percentiel en 90 percentiel van het stikstofgehalte in het oppervlaktewater van de Westerschelde en de monding."}
...
<!-- \begin{table}[!ht] -->
<!--  \centering -->
<!--  \input{../Figuren/Fysisch/Stikstof_par/meanvalues.tex} -->
<!--  \caption[Waardes van het particulair stikstofgehalte in het oppervlaktewater]{Gemiddelde, minimale en maximale waardes van het particulair stikstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data tussen 1996 en 2018.}  -->
<!--  \label{tab:fysisch_stikstof_par} -->
<!-- \end{table} -->
...
knitr::kable(dt, 
             ...
             caption = "Gemiddelde, 10-percentiel en 90-percentiel waardes en de trend en p waarde van de trend van het particulair stikstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```

<!-- \begin{figure}[h!]  -->
<!-- \centering -->
<!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Stikstof_par/jaar.png} -->
<!--  \caption[Jaarlijks gemiddelde particulair stikstofgehalte in het oppervlaktewater]{Jaarlijks gemiddelde, minimum en maximum van het particulair stikstofgehalte in het oppervlaktewater van de Westerschelde en de monding.}  -->
<!--  \label{fig:fysisch_stikstof_par} -->
<!-- \end{figure}  -->

```{r fysischStikstofPar, fig.cap="Jaarlijks gemiddelde, 10-percentiel en 90-percentiel van het particulair stikstofgehalte in het oppervlaktewater van de Westerschelde en de monding."}
parname = "Stikstof in mg/l particulair gebonden in oppervlaktewater"
plotTrends(df, parname)
```
...
<!-- \begin{figure}[h!]  -->
<!-- \centering -->
<!--   \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Stikstof_par/gemiddelde_waardes.png} -->
<!--  \caption[Gemiddeld particulair stikstofgehalte  per station op een kaart]{Gemiddelde hoeveelheid particulair stikstofgehalte na filtratie per station berekend op alle beschikbare data tussen 1997 en 2018} -->
<!--  \label{fig:gemiddeldestikstof_par} -->
<!-- \end{figure}  -->
...
<!-- \begin{table}[!ht] -->
<!--  \centering -->
<!--  \input{../Figuren/Fysisch/Ammonium/meanvalues.tex} -->
<!--  \caption[Waardes van het ammoniumgehalte in het oppervlaktewater]{Gemiddelde, minimale en maximale waardes van het ammoniumgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data tussen 1996 en 2018.}  -->
<!--  \label{tab:fysisch_Ammonium} -->
<!-- \end{table} -->
...
knitr::kable(dt, 
             caption = "Gemiddelde, minimale en maximale waardes van het ammoniumgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischAmmonium, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het ammoniumgehalte in het oppervlaktewater van de Westerschelde en de monding."}
...
dt <- statTable(df, parname, 3)
knitr::kable(dt,
             caption = "Gemiddelde, minimale en maximale waardes van het nirtietgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischNitriet, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het nitrietgehalte in het oppervlaktewater van de Westerschelde en de monding."}
...
dt <- statTable(df, parname, 3)
knitr::kable(dt, 
             caption = "Gemiddelde, minimale en maximale waardes van het nirtaatfgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischNitraat, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het nitraatgehalte in het oppervlaktewater van de Westerschelde en de monding."}
...
dt <- statTable(df, parname, 3)
knitr::kable(dt, 
             caption = "Gemiddelde, minimale en maximale waardes van het orthofosfaatgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischOrthofosfaat, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het orthofosfaatgehalte in het oppervlaktewater van de Westerschelde en de monding."}
...
<!-- \begin{figure}[h!]  -->
<!-- \centering -->
<!--   \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Orthofosfaat/gemiddelde_waardes.png} -->
<!--  \caption[Gemiddeld orthofosfaatgehalte per station op een kaart]{Gemiddelde orthofosfaatgehalte  per station berekend op alle beschikbare data tussen 2009 en 2018} -->
<!--  \label{fig:gemiddeldeorthofosfaat} -->
<!-- \end{figure}  -->
...
statTable(df, parname, 3)
knitr::kable(dt, 
             caption = "Gemiddelde, minimale en maximale waardes van het fosfaatgehalte na filtratie in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischFosfaatFil, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het fosfaatgehalte in het oppervlaktewater van de Westerschelde en de monding."}
parname <- "Fosfaat, totaal in mg/l na filtratie in oppervlaktewater"
...
dt <- statTable(df, parname, 3)
knitr::kable(dt,
             caption = "Gemiddelde, minimale en maximale waardes van het particulair gebonden fosfaatgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischFosfaatPar, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het particulair gebonden fosfaatgehalte in het oppervlaktewater van de Westerschelde en de monding."}
parname = "Fosfaat, totaal in mg/l particulair gebonden in oppervlaktewater" 
plotTrends(df, parname)
```
...
dt <- statTable(df, parname, 3)
knitr::kable(dt, 
             caption = "Gemiddelde, minimale en maximale waardes van het silicaatgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```



```{r fysischSilicaat, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het silicaatgehalte in het oppervlaktewater van de Westerschelde en de monding."}
...
<!-- <!-- \begin{table}[!ht] --> -->
<!-- <!--  \centering --> -->
<!-- <!--  \input{../Figuren/Fysisch/Koolstof_opg/meanvalues.tex} --> -->
<!-- <!--  \caption[Waardes van het opgeloste koolstofgehalte in het oppervlaktewater]{Gemiddelde, minimale en maximale waardes van het opgeloste koolstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data tussen 1996 en 2018.}  --> -->
<!-- <!--  \label{tab:fysisch_koolstof_opg} --> -->
<!-- <!-- \end{table} --> -->

<!-- ```{r fysischKoolstofOpgTab} -->
<!-- dt <- tex2dt("Figuren/Fysisch/Koolstof_opg/meanvalues.tex") -->
<!-- knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"), -->
<!--              caption = "Gemiddelde, minimale en maximale waardes van het opgeloste koolstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.") -->
<!-- ``` -->

<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Koolstof_opg/jaar.png} --> -->
<!-- <!--  \caption[Jaarlijks gemiddelde opgeloste koolstofgehalte in het oppervlaktewater]{Jaarlijks gemiddelde, minimum en maximum van het opgeloste koolstofgehalte in het oppervlaktewater van de Westerschelde en de monding. Wielingen wordt sinds 2009 niet meer gemeten.}  --> -->
<!-- <!--  \label{fig:fysisch_koolstof_opg} --> -->
<!-- <!-- \end{figure}  --> -->

<!-- ```{r fysischKoolstofOpg, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het opgeloste koolstofgehalte in het oppervlaktewater van de Westerschelde en de monding."} -->
<!-- knitr::include_graphics("Figuren/Fysisch/Koolstof_opg/jaar.png") -->
<!-- ``` -->
...
<!-- <!-- \begin{table}[!ht] --> -->
<!-- <!--  \centering --> -->
<!-- <!--  \input{../Figuren/Fysisch/Koolstof_par/meanvalues.tex} --> -->
<!-- <!--  \caption[Waardes van het particulair gebonden koolstofgehalte in het oppervlaktewater]{Gemiddelde, minimale en maximale waardes van het particulaire koolstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data tussen 1996 en 2018.}  --> -->
<!-- <!--  \label{tab:fysisch_koolstof_par} --> -->
<!-- <!-- \end{table} --> -->

<!-- ```{r fysischKoolstofParTab} -->
<!-- dt <- tex2dt("Figuren/Fysisch/Koolstof_par/meanvalues.tex") -->
<!-- knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"), -->
<!--              caption = "Gemiddelde, minimale en maximale waardes van het particulaire koolstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.") -->
<!-- ``` -->

<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Koolstof_par/jaar.png} --> -->
<!-- <!--  \caption[Jaarlijks gemiddelde particulaire koolstofgehalte in het oppervlaktewater]{Jaarlijks gemiddelde, minimum en maximum van het particulaire koolstofgehalte in het oppervlaktewater van de Westerschelde en de monding. Wielingen wordt sinds 2009 niet meer gemeten.}  --> -->
<!-- <!--  \label{fig:fysisch_koolstof_par} --> -->
<!-- <!-- \end{figure}  --> -->

<!-- ```{r fysischKoolstofPar, fig.cap="Jaarlijks gemiddelde, minimum en maximum van het particulaire koolstofgehalte in het oppervlaktewater van de Westerschelde en de monding."} -->
<!-- knitr::include_graphics("Figuren/Fysisch/Koolstof_par/jaar.png") -->
<!-- ``` -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Koolstof_par/Zomer_winter.png} --> -->
<!-- <!--  \caption[Particulaire koolstofgehalte gedurende zomer en winter in het oppervlaktewater]{Gemiddeld waardes voor de hoeveelheid particulaire koolstofgehalte gedurende de zomer en de winter in het oppervlaktewater van de Westerschelde en de monding} --> -->
<!-- <!--  \label{fig:fysisch_koolstof_par_Zomer_winter} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--   \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Koolstof_opg/gemiddelde_waardes.png} --> -->
<!-- <!--  \caption[Gemiddeld opgeloste koolstofgehalte per station op een kaart]{Gemiddelde opgeloste koolstofgehalte station berekend op alle beschikbare data tussen 1996 en 2018} --> -->
<!-- <!--  \label{fig:gemiddeldekoolstofopg} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--   \includegraphics[width=1\linewidth]{../Figuren/Fysisch/Koolstof_par/gemiddelde_waardes.png} --> -->
<!-- <!--  \caption[Gemiddeld  particulaire koolstofgehalte per station op een kaart]{Gemiddelde particulaire koolstofgehalte station berekend op alle beschikbare data tussen 1996 en 2018} --> -->
<!-- <!--  \label{fig:gemiddeldekoolstofpar} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- $N = 106*\frac{{PN/14}}{{POC/12}}$ -->
<!-- $P = 106*\frac{{PP/31}}{{POC/12}}$ -->
...
<!-- <!-- \begin{table}[!ht] --> -->
<!-- <!--  \centering --> -->
<!-- <!--  \input{../Figuren/Fysisch/CNP/meanvalues.tex} --> -->
<!-- <!--  \caption[Waardes van de CNP ratio's van het oppervlaktewater]{Gemiddelde molaire C-N-P-ratio uitgedrukt ten opzichte van een gehalte C van 106 gemiddeld over alle data van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data tussen 1996 en 2018.}  --> -->
<!-- <!--  \label{tab:fysisch_CNP} --> -->
<!-- <!-- \end{table} --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/CNP/N_jaar.png} --> -->
<!-- <!--  \caption[Jaarlijks gemiddelde N-C ratio van het oppervlaktewater]{De molaire N-C-ratio, N uitgedrukt ten opzichte van een gehalte C van 106, gemiddeld over een jaar in het oppervlaktewater van de Westerschelde en de monding.}  --> -->
<!-- <!--  \label{fig:fysisch_N_jaar} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/CNP/P_jaar.png} --> -->
<!-- <!--  \caption[Jaarlijks gemiddelde PC ratio van het oppervlaktewater]{De molaire P-C-ratio, P uitgedrukt ten opzichte van een gehalte C van 106, gemiddeld over een jaar in het oppervlaktewater van de Westerschelde en de monding.}  --> -->
<!-- <!--  \label{fig:fysisch_P_jaar} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/CNP/NP_jaar.png} --> -->
<!-- <!--  \caption[Jaarlijks gemiddelde NP ratio van het oppervlaktewater]{De molaire N-P-ratio, N uitgedrukt ten opzichte van een gehalte P, over een jaar in het oppervlaktewater van de Westerschelde en de monding.}  --> -->
<!-- <!--  \label{fig:fysisch_NP_jaar} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/CNP/N_Zomer_winter.png} --> -->
<!-- <!--  \caption[NC ratio's gedurende zomer en winter van het oppervlaktewater]{De molaire N-C-ratio, N uitgedrukt ten opzichte van een gehalte C van 106, gemiddeld over de zomer en winterperiode in het oppervlaktewater van de Westerschelde en de monding.}  --> -->
<!-- <!--  \label{fig:fysisch_N_zw} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/CNP/P_Zomer_winter.png} --> -->
<!-- <!--  \caption[PC ratio's gedurende zomer en winter van het oppervlaktewater]{De molaire P-C-ratio, P uitgedrukt ten opzichte van een gehalte C van 106, gemiddeld over de zomer en winterperiode in het oppervlaktewater van de Westerschelde en de monding.}  --> -->
<!-- <!--  \label{fig:fysisch_P_zw} --> -->
<!-- <!-- \end{figure}  --> -->
...
<!-- <!-- \begin{figure}[h!]  --> -->
<!-- <!-- \centering --> -->
<!-- <!--  \includegraphics[width=1\linewidth]{../Figuren/Fysisch/CNP/NP_Zomer_winter.png} --> -->
<!-- <!--  \caption[NP ratio's gedurende zomer en winter van het oppervlaktewater]{De molaire N-P-ratio, P uitgedrukt ten opzichte van een gehalte P, gemiddeld over de zomer en winterperiode in het oppervlaktewater van de Westerschelde en de monding.}  --> -->
<!-- <!--  \label{fig:fysisch_NP_zw} --> -->
<!-- <!-- \end{figure}  --> -->
