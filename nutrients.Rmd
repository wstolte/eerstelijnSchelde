...
dt <- statTable(df, parname, 3)
knitr::kable(dt,
             caption = "Gemiddelde, minimale en maximale waardes van het nitrietgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare data vanaf 1996.")
```
