...
statname = "Schaar van Ouden Doel"
...
#              
fytStatTable(df.fyt.groep,  stationname = 'Hansweert Geul') %>%
  select(-stationname) %>%
  rename(groepsnaam = parametername) %>% 
