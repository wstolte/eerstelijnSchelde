...
```{r arseenBodem, fig.height = 8, fig.cap="Arseen in het bodemsediment in de Westerschelde"}
...
plotTrends(df, parname) + facet_wrap(~Station, ncol = 4)
